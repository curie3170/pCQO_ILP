...
LOG_DIR="${BASE_DIR}/../fobc/fast_tune+ILP/${SUBDIR}"
...
for graph_path in "$GRAPH_DIR"/*.clq; do
    ...
    log_path="${LOG_DIR}/${base_name}_tuningiter${TUNEITER}_repeated_fixed_sample_9lr.log"
    log_path_gurobi="${LOG_DIR}/${base_name}_tuningiter${TUNEITER}_repeated_fixed_sample_9lr_GurobiInit.log"
    ...
    #1000_repeated_fixed_sample_9lr
    CMD1="${EXEC_PATH} ${graph_path} 0.00009 0.7 500000 500 250 3 256 2.25 10"
    CMD2="${EXEC_PATH} ${graph_path} 0.00009 0.7 500000 500 250 3 256 2.25 10 \"${BINARY_STRING}\""
    #5000_repeated_fixed_sample_9lr
    # CMD1="${EXEC_PATH} ${graph_path} 0.000001 0.9 500000 500 500 7 256 2.25 10"
    # CMD2="${EXEC_PATH} ${graph_path} 0.000001 0.9 500000 500 500 7 256 2.25 10 \"${BINARY_STRING}\""

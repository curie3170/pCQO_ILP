...
base_solvers = [
    {"name": "ReduMIS", "class": ReduMIS, "params": {"time_limit":0, "dataset": "KaMIS_er_700-800_0sec"}}, 
    {"name": "ReduMIS", "class": ReduMIS, "params": {"time_limit":1, "dataset": "KaMIS_er_700-800_1sec"}}, 
    {"name": "Gurobi_warm", "class": GurobiMIS_warm, "params": {"time_limit": 30, "dataset": "KaMIS_er_700-800_0sec", "warm_sample_rate": 0.15}},
    {"name": "Gurobi_warm", "class": GurobiMIS_warm, "params": {"time_limit": 30, "dataset": "KaMIS_er_700-800_1sec", "warm_sample_rate": 0.15}},
]

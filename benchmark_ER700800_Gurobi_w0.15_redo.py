...
from lib.dataset_generation_redo import assemble_dataset_from_gpickle
...
base_solvers = [
    {
        ...
        "params": {
            ...
            # "momentum": 0.9,
            "number_of_steps": 132750, #225000, #approximately 30sec
            # "gamma": 350,
            # "gamma_prime": 7,
            "batch_size": 256,
            "std": 2.25,
            "threshold": 0.00,
            "steps_per_batch": 450,
            "output_interval": 132752,#225002,
            "value_initializer": "degree",
            "checkpoints": [450] + list(range(4500, 132752, 4500)),
            #"time_limit": 30,
            "dataset": "er_700-800_fasttune_132750steps", #er_dense
        },
    },
    {"name": "Gurobi_warm", "class": GurobiMIS_warm, "params": {"time_limit": 30, "dataset": "er_700-800_fasttune_132750steps", "iteration": 450, "warm_sample_rate": 0.15}},
    {"name": "Gurobi_warm", "class": GurobiMIS_warm, "params": {"time_limit": 30, "dataset": "er_700-800_fasttune_132750steps", "iteration": 131850, "warm_sample_rate": 0.15}},
]

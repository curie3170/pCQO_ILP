...
for graph_path in "$GRAPH_DIR"/*.clq; do
    ...
    log_path="${LOG_DIR}/${base_name}_tuningiter${TUNEITER}_unfixed_8lr.log"
    log_path_gurobi="${LOG_DIR}/${base_name}_tuningiter${TUNEITER}_unfixed_8lr_GurobiInit.log"
    ...
    #5000
    CMD1="${EXEC_PATH} ${graph_path} 0.0001 0.99 500000 500 250 3 256 2.25 10"
    CMD2="${EXEC_PATH} ${graph_path} 0.0001 0.99 500000 500 250 3 256 2.25 10 \"${BINARY_STRING}\""
